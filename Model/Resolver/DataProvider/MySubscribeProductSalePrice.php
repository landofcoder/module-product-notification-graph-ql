...
class MySubscribeProductSalePrice
{
    ...
    public function getMySubscribeProductSalePrice($args, $context)
    {
        ...
        $searchCriteria = $this->searchCriteriaBuilder->build( 'mySubscribeProductSalePrice', $args );
        $searchCriteria->setCurrentPage( $args['currentPage'] );
        $searchCriteria->setPageSize( $args['pageSize'] );

        $searchResult = $this->apiRepository->getListPrice($customer_id, $searchCriteria );
